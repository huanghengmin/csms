...
<%@page contentType="text/html;charset=utf-8" import="com.hzih.ra.web.SiteContext"%>
...
<div
	style="width: 466px; height: 300px; border: 0px solid #000000; margin: 0 auto; margin-top: 50px; background: url(img/login-ZD-RA.jpg) no-repeat;">
