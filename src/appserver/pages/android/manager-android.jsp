...
<html>
    <head>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/js/system/manager-android.js"></script>
...
<head>
    <title>终端版本升级</title>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/android/manager-android.js"></script>
</head>