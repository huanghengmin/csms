...
//	 private static final Logger logger = Logger.getLogger(GetListNetInfo.class);
...
//	}
	 ...
	 * @return
	 */
	public List<NetInfo> readRouter() throws Exception{
		OSInfo osInfo = OSInfo.getOSInfo();
	...
	public String deleteRouter(List<NetInfo> netInfos) throws Exception{
		...
		if(osInfo.isLinux()){
            ...
            String command = "service networking restart";
            proc.exec(command);
            Thread.sleep(5*1000);
