...
import com.hzih.ra.web.action.mc.api.DataAttributes;
import com.hzih.ra.web.action.mc.api.Status;
...
public class TSRSHttpclient {
    ...
    /*
      * 终端进程信息
      */
    public DataAttributes processquery(String ip, String policeno)throws Exception {
        DataAttributes buff = new DataAttributes();
