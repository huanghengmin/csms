package com.hzih.ra.web.taglib;
...
public class PageBarTag extends TagSupport {
	...
	private static final String ONE_A = "<p style='float:right'><batchImportUser type='button' value='go' onclick=\"javascript:window.location='";
	...
	private static final String ONE_I = "'>末页</a> 跳到 <batchImportUser type='text' id='go_index' name='go_index'   style='width:30px'  /> 页</p>";
	...
	// finished by collin 2008.8.8
	private static final String _ONE_A = "<p style='float:right'><batchImportUser type='button' value='go' onclick=\"javascript:";
	...
	private static final String _ONE_I = "'>末页</a> 跳到 <batchImportUser type='text' id='go_index' name='go_index'   style='width:30px'  /> 页</p>";
