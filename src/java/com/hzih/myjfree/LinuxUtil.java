package com.hzih.myjfree;

import ch.ethz.ssh2.Connection;
import ch.ethz.ssh2.Session;
import ch.ethz.ssh2.StreamGobbler;
import com.hzih.ra.entity.NetInfo;
import com.hzih.ra.utils.GetListNetInfo;
...
//        System.out.println(linuxUtil.getLinuxByCommand("192.168.1.231", "root", "admin","openssl pkcs12 -in /home/caixiang.p12 -passin pass:123456 -nocerts -out /home/caixiang.pem -passout pass:123456"));
        String line = linuxUtil.getProcessInfo("192.168.1.232", "root", "admin", "ps -eo pid,lstart,etime,args", "nginx:");
...
//        }
        ...
        if(aa[0].equals("")) {
            ...
            msg = "自"+aa[5]+"-"+aa[2]+"-"+aa[3]+" "+aa[4]+"至今,共"+aa[6];
        }
//        System.out.println(msg);
//        System.out.println(linuxUtil.getRxBytesNum("192.168.1.231", "root", "admin"));
    }
